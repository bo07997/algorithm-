...
<head>
	...
	<style type="text/css">@import url('${ctx}/resources/root/components/dtree/dtree.css');</style>
	<script type="text/javascript">var dtreeIconBasePath = "${ctx}/resources/root/components/dtree";</script>
	<script type="text/javascript"  src="${ctx}/resources/root/components/dtree/dtree.js"></script>
</head>
<body>
<script type="text/javascript"> 
var treeMenu = [
	{ level:1, name:"博客管理"},
	{ level:2, name:"全部博客", ico:"${ctx}/resources/root/images/icon_default.gif",link:"${ctx}/User/root/all_blog/0"},
	{ level:2, name:"博客审核", ico:"${ctx}/resources/root/images/icon_default.gif",link:"${ctx}/User/root/all_root_blog"},
	{ level:1, name:"用户管理"},
	{ level:2, name:"全部用户", ico:"${ctx}/resources/root/images/icon_default.gif",link:"${ctx}/User/root/all_user"},
	{ level:2, name:"管理员", ico:"${ctx}/resources/root/images/icon_default.gif",link:"${ctx}/User/root/all_root"},
	{ level:1, name:"评论管理"},
	{ level:2, name:"全部评论", ico:"${ctx}/resources/root/images/icon_default.gif",link:"${ctx}/Comment/root/all_root_comment"},
];
</script>
<style>
* {
