...
<ul id="blog_statistics">
  ...
  background:#ff7900" onclick="up_down(1)"><dt>顶</dt><dd id="uptimes">${blog.up}</dd></button>
  <button type="button" class="btn btn-default"style="  padding: 30px 30px;
  background:#ff7900" onclick="up_down(2)"><dt>踩</dt><dd id="downtimes">${blog.down}</dd></button>
  </div>
		</div>
		
		<div id="articleComment" name="articleComment" ></div>
